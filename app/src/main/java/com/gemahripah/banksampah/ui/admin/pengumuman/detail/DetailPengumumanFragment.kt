...
class DetailPengumumanFragment : Fragment(), Reloadable {
                ...
                Glide.with(binding.gambar)
                    ...
                    .listener(object : RequestListener<Drawable> {
                        override fun onLoadFailed(
                            ...
                            _binding?.let {
                                it.teksErrorGambar.visibility = View.VISIBLE
                                it.gambar.visibility = View.GONE
                            }
                        ...
                        override fun onResourceReady(
                            ...
                            _binding?.let {
                                it.gambar.visibility = View.VISIBLE
                            }
                            viewModel.setLoading(false)
                            return false
                        }
    ...
    private fun showLoading(isLoading: Boolean) {
        _binding?.let {
            it.loading.visibility = if (isLoading) View.VISIBLE else View.GONE
            it.layoutKonten.alpha = if (isLoading) 0.3f else 1f
            it.hapus.isEnabled = !isLoading
            it.edit.isEnabled = !isLoading
        }
    }
